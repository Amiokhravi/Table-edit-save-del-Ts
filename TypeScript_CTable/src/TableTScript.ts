...
let medal_box = document.getElementsByClassName('background_medal') as HTMLCollectionOf<HTMLElement>;
let table : any = document.getElementById('mytable') as HTMLElement;
...
//وارد کردن اطلاعات
    function insert_data() {
        let current_row_number : any = document.getElementById("mytable").lastElementChild.lastElementChild.firstElementChild.innerHTML;
...
function edit(event) {
    ...
    (<HTMLInputElement>document.getElementById('edit_name')).value = now_name
    (<HTMLInputElement>document.getElementById('edit_age')).value = now_age
    (<HTMLInputElement>document.getElementById('edit_city')).value = now_city
    (<HTMLInputElement>document.getElementById('edit_country')).value = now_country
    // remove_medal()

    return  c_row= row.cells
}
function edit_tbl() {
    let current_row_number = c_row[0].innerHTML
    // inert_data
    let new_name = (<HTMLInputElement>document.getElementById('edit_name')).value
    let new_age = (<HTMLInputElement>document.getElementById('edit_age')).value
    let new_city = (<HTMLInputElement>document.getElementById('edit_city')).value
    let new_country = (<HTMLInputElement>document.getElementById('edit_country')).value
...
function delete_row(event){
    ...
    (<HTMLInputElement>document.getElementById("mytable")).deleteRow(row_index);
}
...
function Pager(tableName, itemsPerPage) {
    ...
    this.showRecords = function (from, to) {
        let rows= (<HTMLTableElement >document.getElementById(tableName)).rows;
    ...
    this.showPage = function (pageNumber) {
        ...
        let pgNext = (<HTMLInputElement>document.querySelector('.pg-next'));
        let pgPrev = (<HTMLInputElement>document.querySelector('.pg-prev'));
