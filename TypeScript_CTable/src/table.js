...
//وارد کردن اطلاعات
    function insert_data() {
        let current_row_number = document.getElementById("mytable").lastElementChild.lastElementChild.firstElementChild.innerHTML;
...
function delete_row(event){
    let row_index=event.target.parentElement.parentElement.sectionRowIndex+2
